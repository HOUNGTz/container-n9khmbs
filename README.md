...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-n9khmbs.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-n9khmbs.containers.anotherwebservice.com/
...
```
git clone git@github.com:HOUNGTz/container-n9khmbs.git
cd container-n9khmbs
```
...
```
docker attach container-n9khmbs
```
